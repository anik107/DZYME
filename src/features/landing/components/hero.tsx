...
function Hero() {
  return (
    <section className="px-3 pt-3 sm:px-6 sm:pt-4 lg:px-[3.75vw]">
      <div className="relative isolate min-h-[814px] overflow-hidden rounded-lg bg-white shadow-[0px_2px_6px_0px_rgba(0,0,0,0.1)] sm:rounded-2xl">
        ...
        <Navbar className="relative z-10 pt-4" />

        <motion.div
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
          className="mx-auto flex w-full max-w-[826px] flex-col items-center gap-8 px-4 pt-32 pb-24 text-center sm:pt-60"
        >
